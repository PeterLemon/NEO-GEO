// NEO-GEO Green Space demo by krom (Peter Lemon):
...
Start:
  ...
  move.w  (a0)+,(a1)+
  lea.l   COL_PAL_REG+255*32+30,a1 // A1 = BG Palette Destination Address ($401FFE)
  move.w  (a0)+,(a1)+ // Copy 1 BG Palette Color (2 Bytes)
...
Message:
  db "BG Palette #255, Color #15 Set Green:" // Message Text

align(2) // Align 16-Bit
Palette:
  dw $0000,$FFFF // Fix Palette #1 (2 Colors)
  dw $20F0       // BG Palette #255 (1 Color)