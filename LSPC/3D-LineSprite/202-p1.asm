...
Start:
  ...
  move.w  #1,d0 // D0 = Number Of Palettes To Transfer - 1
  ...
  move.w  #34,d0     // D0 = Number Of Characters To Print - 1
  ...
  move.w  #$E801,LSPC_DATA_REG // Bits 7..15 = Sprite Y Position, Bit 6 = Chain Bit, Bits 0..5 = Number of Active Characters ($8300)
  move.w  #$4800,LSPC_DATA_REG // Bits 7..15 = Sprite X Position ($8500)
...
Message:
  db "16x16 Sprite, 1 * 16 Color Palette:" // Message Text
...
Palette:
  ...
  insert "GFX/eye.pal" // Palette #2 (16 Colors)